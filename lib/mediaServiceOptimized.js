...
export class MediaServiceOptimized {
    ...
    static async uploadVideoWithFetch(fileUri, fileName, bucket, mimeType, onProgress = null) {
        try {
            ...
            return await this.uploadVideoToCloudinary(fileUri, fileName, finalMimeType, onProgress);
    ...
    static async uploadVideoToCloudinary(fileUri, fileName, mimeType, onProgress = null) {
        try {

...
export class MediaServiceOptimized {
    ...
    static async saveStoryToDatabase(publicUrl, title, mediaType) {
        try {
    ...
    static async uploadStory(fileUri, title = 'Story', mediaType = 'image', onProgress = null) {
        try {
            ...
            // Usar a função uploadToSupabase existente
            ...
            // Salvar no banco de dados
            const dbResult = await this.saveStoryToDatabase(publicUrl, title, mediaType);

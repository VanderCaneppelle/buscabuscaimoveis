...
export class MediaServiceOptimized {
    ...
    static async uploadVideoAndroidChunked(fileUri, fileName, mimeType, onProgress = null) {
        try {
            console.log('🤖 Upload em chunks para vídeo grande (Android) via backend');
            ...
            for (let chunkIndex = 0; chunkIndex < totalChunks; chunkIndex++) {
                ...
                // Ler chunk específico (somente este chunk na memória)
                ...
                // Enviar chunk para o backend
                const response = await fetch('https://buscabusca.vercel.app/api/upload-video', {
                    method: 'POST',
            ...
            console.log('✅ Upload concluído, vídeo enviado com sucesso!');

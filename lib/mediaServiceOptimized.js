...
export class MediaServiceOptimized {
    ...
    static async saveStoryToDatabase(publicUrl, title, mediaType, thumbnailUrl = null, linkUrl = null, linkText = null) {
        try {
    ...
    static async uploadStory(fileUri, title = 'Story', mediaType = null, onProgress = null, linkData = null) {
        try {
            ...
            // Salvar no banco de dados
            const dbResult = await this.saveStoryToDatabase(publicUrl, title, mediaType, thumbnailUrl, linkData?.url, linkData?.text);

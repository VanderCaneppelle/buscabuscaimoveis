...
export const PushNotificationService = {
    ...
    scheduleDailyNotifications: async () => {
        try {
            ...
            // Mensagens e horários solicitados
            const notifications = [
                {
                    id: 'reminder_morning_0940',
                    title: 'BOM DIA!!',
    ...
    registerDeviceToken: async (token, userId) => {
        try {
            const apiUrl = process.env.EXPO_PUBLIC_API_BASE_URL|| Constants.expoConfig?.extra?.EXPO_PUBLIC_API_BASE_URL;
